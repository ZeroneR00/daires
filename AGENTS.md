...
- **Заход был пилотным: перекрашены только шапка, лента `/` и общие атомы**
  ...
  друзей (2026-08-28, свои секции ниже). Остальные страницы
  (`/new`, `/settings`, `/friends`, `/messages`, `/search`, `/login`,
