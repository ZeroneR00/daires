...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    //
    // ВАЖНО при смене палитры: эти два значения обязаны повторять --paper
    // сорта по умолчанию из globals.css, и связь держится только руками —
    // манифест в CSS не заглядывает. Разъедутся — заставка установленного
    // приложения и полоса статуса останутся цвета прошлой темы.
