...
**Найдено заодно, НЕ починено (вне скоупа захода):** у залогиненного
...
сворачивать в меню или резать до иконок.
...
**Подтверждено, не починено:** переполнение шапки на 390 px (шаг 4 плана) видно
на каждом мобильном скриншоте захода — документ вдвое шире вьюпорта, справа
пустое поле. Заход C к нему непричастен, источник прежний —
